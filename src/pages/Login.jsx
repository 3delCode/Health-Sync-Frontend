    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">مرحباً بعودتك! سجل الدخول لمتابعة رحلتك الصحية</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <a
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 rounded-xl hover:bg-gray-50 transition-colors text-gray-700 font-medium text-sm"
          >
        ...
        <div className="text-center mt-6">
          <div className="inline-flex items-center gap-2 text-xs text-gray-400">
            ...
            <span>بياناتك محمية بتقنيات التشفير المتقدمة</span>
          </div>
        </div>
      </div>
    </div>
